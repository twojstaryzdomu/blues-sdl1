...
extern void	screen_add_sprite(int x, int y, int frame, bool centred);
...
extern void	screen_add_game_sprite1(int x, int y, int frame, bool centred);
extern void	screen_add_game_sprite2(int x, int y, int frame, bool centred);
